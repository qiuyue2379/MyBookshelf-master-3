package com.monke.monkeybook.update;
...
// json {"url":"http://192.168.205.33:8080/Hello/app_v3.0.1_Other_20150116.apk","versionCode":2,"updateMessage":"版本更新信息"}
    ...
    static final String UPDATE_URLL = "http://qiuyue.vicp.net:85/apk/release/output.json";
    static final String UPDATE_URLI = "http://qiuyue.vicp.net:85/apk/release/";
    static final String UPDATE_URL = "http://qiuyue.vicp.net:85/apk/update.json";
}